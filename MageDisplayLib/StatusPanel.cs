...
namespace MageDisplayLib {
    ...
    public partial class StatusPanel : UserControl {
		...
		private System.Collections.Generic.List<string> mWarningMessages;
        ...
        private void CancelCtl_Click(object sender, EventArgs e) {
            if (OnAction != null) {
                OnAction(this, new MageCommandEventArgs("cancel_operation"));
            }
        }
		...
		private void AddNewWarningMessage(string message) {
			if (OwnerControl.InvokeRequired) {
				...
				try {
					OwnerControl.Invoke(ncb, new object[] { message });
		...
		private void WarningsCtl_Click(object sender, EventArgs e) {
			TextDisplayForm frmWarnings = new TextDisplayForm();

			frmWarnings.Text = "Mage Warnings";
			frmWarnings.ReadOnly = true;
