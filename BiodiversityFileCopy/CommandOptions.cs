...
namespace BiodiversityFileCopy
{
    class CommandOptions
    {
        public static Boolean InterpretCommandLineOptions(Processing proc, string[] args)
        {
            ...
            Logging.LogRootFolder = proc.OutputRootFolderPath;
            ...
            if (string.IsNullOrEmpty(proc.DataPkgsToProcess))
            {
                Logging.StatusMessage(string.Format("No data packages   to process were specified"));
                return false;
            }
