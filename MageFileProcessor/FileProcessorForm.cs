...
namespace MageFileProcessor {
    ...
    public partial class FileProcessorForm : Form {
        ...
        public FileProcessorForm() {
			...
			SetFormTitle("2011-10-21", isBetaVersion);
            ...
            try {
                ...
                switch (command.Action) {
                    ...
                    case "get_files_from_entities":
                        ...
                        mCurrentPipeline = Pipelines.MakeFileListPipeline(source, sink, runtimeParms);
                        break;
                    case "get_files_from_local_folder":
                        ...
                        sink = FileListDisplayControl.MakeSink("Files", 15);
                        mCurrentPipeline = Pipelines.MakePipelineToGetLocalFileList(sink, runtimeParms);
                        break;
                    ...
                    case "get_files_from_local_manifest":
                        ...
                        sink = FileListDisplayControl.MakeSink("Files", 15);
                        mCurrentPipeline = Pipelines.MakePipelineToGetFilesFromManifest(sink, runtimeParms);
                        break;
                    case "copy_files":
                    ...
                    case "process_file_contents":
						...
						source = new GVPipelineSource(FileListDisplayControl, mode);
                        mCurrentPipeline = Pipelines.MakePipelineToFilterSelectedfiles(source, runtimeParms, filterParms);
                        break;
                    default:
                        return;
                }
