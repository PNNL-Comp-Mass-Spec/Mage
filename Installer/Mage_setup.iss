...
Source: ..\DeployedFiles\MageConcatenator\log4net.dll                   ; DestDir: {app}\MageConcatenator
...
Source: ..\DeployedFiles\Ranger\log4net.dll                             ; DestDir: {app}\Ranger
