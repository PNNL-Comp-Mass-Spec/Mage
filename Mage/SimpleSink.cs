...
namespace Mage
{
    ...
    public class SimpleSink : BaseModule
    {
        ...
        public bool TryGetValueViaColumnName(string columnName, int rowIndex, out double value)
        {
            ...
            return ColumnIndex.TryGetValue(columnName, out var colIndex) &&
                   double.TryParse(Rows[rowIndex][colIndex], out value);
        }
        ...
        public bool TryGetValueViaColumnName(string columnName, int rowIndex, out int value)
        {
            ...
            return ColumnIndex.TryGetValue(columnName, out var colIndex) && int.TryParse(Rows[rowIndex][colIndex], out value);
        }
