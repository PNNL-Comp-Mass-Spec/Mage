...
[assembly: SuppressMessage("Readability", "RCS1123:Add parentheses when necessary.", Justification = "Parentheses not needed", Scope = "member", Target = "~M:Mage.PermutationGenerator.ParameterDef.CalculateIncrements")]
[assembly: SuppressMessage("Redundancy", "RCS1213:Remove unused member declaration.", Justification = "Leave for future usage", Scope = "member", Target = "~M:Mage.FileCopy.GetDirectorySafeLongPath(System.String)~System.String")]
[assembly: SuppressMessage("Roslynator", "RCS1146:Use conditional access.", Justification = "Leave as-is for readability", Scope = "member", Target = "~M:Mage.FileListInfoBase.SearchDirectoriesAndOutputFiles")]
