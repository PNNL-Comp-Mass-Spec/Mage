...
namespace MageFilePackager {
    ...
    public partial class FilePackagerForm : Form {
        ...
        public FilePackagerForm() {
            ...
            SetFormTitle("2012-04-21", isBetaVersion);
...
//--            return ModuleDiscovery.GetQueryXMLDef(queryName);
        ...
        private void SetupFlexQueryPanels() {
            ...
            JobFlexQueryPanel.SetColumnPickList(new[] { "Job", "State", "Dataset", "Dataset_ID", "Tool", "Parameter_File", "Settings_File", "Instrument", "Experiment", "Campaign", "Organism", "Organism DB", "Protein Collection List", "Protein Options", "Comment", "Job_Finish" });
